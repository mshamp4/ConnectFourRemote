...
/**
 * This class holds the properties of a connect four circle. These
 * properties include which player controls the cell, whether or not 
 * the cell has been clicked on, and the rating of the cell that is
 * used to assist the logic of the AI.
 * 
...
public class cfCell {
	...
	/**
	 * Getter method that returns whether or not the cell
	 * has been selected.
	 * 
	...
	/**
	 * Getter method that returns the rating of a cell. The higher
	 * rating a cell has the better the move is.
	 * 
